...
class ClaudeReviewer {
    ...
    async generateReview(analysisResult) {
        try {
...
建設的で具体的なフィードバックを提供し、改善提案も含めてください。
    ...
    parseReviewResponse(response, analysisResult) {
...
exports.ClaudeReviewer = ClaudeReviewer;
